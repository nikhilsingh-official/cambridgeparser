        ...
        <ul class="sidebar-items">
            <div class="sidebar-group">
                <li class="sidebar-item">
                    ...
                    <h1 class="sidebar-text sidebar-header-text">Soluer</h1>
                </li>
            </div>
            <div class="sidebar-group">
                ...
                <li class="sidebar-item">
                    ...
                    <router-link to="/" class="sidebar-text" active-class="active-link" exact>
                      Dashboard
                    </router-link>                
                </li>
            </div>
            <div class="sidebar-group">
                <label class="sidebar-label">Solving</label>
                <li class="sidebar-item">
                    <div class="sidebar-icon">
            ...
            <div class="sidebar-group">
                ...
                <li class="sidebar-item">
                    ...
                    <a class="sidebar-text">Calendar</a>
                </li>
            </div>
            <div class="sidebar-group">
