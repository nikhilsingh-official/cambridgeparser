...
import BlankFieldsPanel from '@/components/BlankFieldsPanel.vue'
import EditorPanel from '@/components/EditorPanel.vue'
import ProblemExplorer from '@/components/ProblemExplorer.vue'
...
import { formatPseudocode } from '@/services/staticParser'
import { parsePseudocode } from '@/services/wasmParser'
...
function selectRecord(id, replace = false) {
  ...
  const target = { name: 'record', params: { id: state.selectedId } }
