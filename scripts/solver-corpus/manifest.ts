...
export const SOLVER_GOLDEN_CORPUS: SolverGoldenCorpus = {
  ...
  papers: [
    {
      paperId: '0455_s16_11', subjectCode: '0455', subject: 'Economics',
      qualification: 'IGCSE', paperNumber: 1, year: 2016, series: 's', variant: 1,
      rationale: ['earliest catalogue generation', 'graph followed by vertical text options', '30 questions'],
      sources: {
        questionPaper: source('0455_s16_qp_11.pdf', '838ae78654cc2aa0bb61df298b9d22c570eeb89a62c62ee3e7715ec3a6c19105', 160757, 12),
        markScheme: source('0455_s16_ms_11.pdf', '469ac4c2eb6e9b3166caf90c40d2da6c08d38caa52c92cc6e2f1eaae36968f7a', 105045, 2),
      },
      expected: {
        questionCount: 30,
        pageQuestionCounts: [0, 2, 3, 3, 2, 3, 3, 4, 4, 4, 2, 0],
        answerKey: 'AACDBADCADBADBABABDCCAACBCDCCB', optionsPerQuestion: 4,
        geometryProbes: [{ question: 1, page: 2, markers: {
          A: [70.9, 255.4, 78.8, 266.4], B: [70.9, 277, 78.8, 288],
          C: [70.9, 298.7, 78.8, 309.7], D: [70.9, 320.3, 78.8, 331.3],
        } }],
      ...
      knownFailures: [{ check: 'ms.answer-key', reason: '2016 two-column key table is not parsed by fetch-pdf.' }],
    },
    {
      paperId: '0610_w16_11', subjectCode: '0610', subject: 'Biology',
      qualification: 'IGCSE', paperNumber: 1, year: 2016, series: 'w', variant: 1,
      rationale: ['old Core layout', 'decision-key question', 'trailing blank pages'],
      sources: {
        questionPaper: source('0610_w16_qp_11.pdf', '1ff77ac42954560181240a924fdef9796b8669ae6b076ee549634ccb01e88fc1', 512561, 20),
        markScheme: source('0610_w16_ms_11.pdf', '4f74565e186f673edcd48555d8e7306bb1e871b2b1a15473d814eecf1c3bc8f6', 130686, 2),
      },
      expected: {
        questionCount: 40,
        pageQuestionCounts: [0, 3, 3, 5, 3, 2, 1, 2, 3, 2, 2, 2, 4, 3, 1, 3, 1, 0, 0, 0],
        answerKey: 'DBDBACAABBCCCDABCBCCBBDBDDACCBCBDDDBDDBA', optionsPerQuestion: 4,
    ...
    },
    {
      ...
      knownFailures: [{ check: 'qp.option-count:8', reason: 'graph-font fallback collapses the four fraction options into one.' }],
    },
    {
    ...
    },
    {
      ...
      knownFailures: [{ check: 'qp.option-count:36', reason: 'the lens diagram produces a duplicate B option.' }],
    },
    {
    ...
    {
      paperId: '9700_w16_13', subjectCode: '9700', subject: 'Biology',
      qualification: 'AS/A Level', paperNumber: 1, year: 2016, series: 'w', variant: 3,
      rationale: ['old A-Level layout', 'matrix options', 'question-marker regression'],
      sources: {
        questionPaper: source('9700_w16_qp_13.pdf', 'f55124ac7e9665cc419e5f3d8540204c3ad7562e5604024fbca04dd494ae9597', 1086535, 20),
        markScheme: source('9700_w16_ms_13.pdf', '8c829ab7cc0b098a71ac213c4846a1619f81c002725bfb97dfd8acc985607e56', 134992, 2),
      },
      expected: {
        questionCount: 40,
        pageQuestionCounts: [0, 4, 2, 2, 2, 2, 3, 2, 3, 3, 1, 2, 3, 2, 3, 4, 2, 0, 0, 0],
        answerKey: 'BBABBDDDACDDCDCDADBCCDDDBACDACBCCCADBAAA', optionsPerQuestion: 4,
        geometryProbes: [], optionTextProbes: [],
      },
      knownFailures: [
        { check: 'qp.question-count', reason: 'dominant-x marker detection returns 44 non-question segments.' },
        { check: 'ms.answer-key', reason: '2016 two-column key table is not parsed by fetch-pdf.' },
      ],
    },
    {
      ...
      knownFailures: [{ check: 'qp.option-text:1', reason: 'spatial labels are returned in A,C,B,D content-stream order.' }],
    },
    {
    ...
    },
    {
      ...
      knownFailures: [{ check: 'qp.option-text:1', reason: 'option letters are paired with the following option text.' }],
    },
    {
      paperId: '5090_s16_11', subjectCode: '5090', subject: 'Biology',
      qualification: 'O Level', paperNumber: 1, year: 2016, series: 's', variant: 1,
      rationale: ['old O-Level biology', 'symbol-key questions', 'two-column mark scheme'],
      sources: {
        questionPaper: source('5090_s16_qp_11.pdf', '660aa8ac9a39ce9a0833a8c2e4d80ebf087f0c25cc9a6839341dde9d79902e7a', 190365, 16),
        markScheme: source('5090_s16_ms_11.pdf', '8c5d1f9e69b70109f3ebd214f89c9beb60d9a9d9cd0cf6d3070b8c5bd9f3ba3c', 104184, 2),
      },
      expected: {
        questionCount: 40,
        pageQuestionCounts: [0, 4, 2, 2, 4, 2, 2, 3, 4, 3, 3, 2, 2, 4, 3, 0],
        answerKey: 'BCADCCCDCBAADCBDCBBCADADBACDCDBCBBCBCADA', optionsPerQuestion: 4,
        geometryProbes: [], optionTextProbes: [],
      },
      knownFailures: [{ check: 'ms.answer-key', reason: '2016 two-column key table is not parsed by fetch-pdf.' }],
    },
    ...
    },
    {
      ...
      knownFailures: [{ check: 'qp.option-count:2', reason: 'A-D in the question stem are mistaken for four additional options.' }],
    },
    {
      ...
      knownFailures: [
        { check: 'qp.option-text:1', reason: 'option letters are paired with the following option text.' },
        { check: 'qp.option-count:13', reason: 'the next question stem contributes an extra D marker.' },
        { check: 'qp.option-count:24', reason: 'inline country labels A-D are mistaken for options.' },
      ],
    },
  ],
};
