...
# imports and RECORDS_PATH were rewritten when this module moved into
# api/ to make the serverless function self-contained. The grading logic is
# unchanged.
...
from api.grading.ast_adapter import AST_VERSION, SCHEMA_VERSION
from api.grading.openrouter_client import DEFAULT_TIMEOUT_SECONDS
from api.grading.router import grade_answer_routed


# The gzipped record set now sits beside this module rather than three levels
# up in the Python package that used to own it. api/ is self-contained: it is
# the only Python left in the repository and reaches into nothing.
RECORDS_PATH = (
