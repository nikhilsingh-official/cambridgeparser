...
const { color, subject, code, icon } = defineProps<{
  color: string;
  subject: string;
  code: string;
  variant: string;
...
<template>
    <div class = "card-container">
        <div class = "expand-sliver-up">
        </div>
        <div class = "expand-sliver-down">
        </div>
        <div class = "sliver-color">
...
.sliver-color {
    ...
    width: 2px;
    height: 100%;
    background: radial-gradient(circle, #fdfddd, v-bind('color'));    
}
.expand-sliver-up {
    position: absolute;
    width: 2px;
...
.card-container:hover {
    ...
    box-shadow: 0 0 16px 4px v-bind('color');
}
